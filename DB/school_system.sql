...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2023 at 03:57 PM
...
(1, 'Admin', 'admin', NULL, 0, '2022-11-12 02:09:01', '2022-11-12 02:09:01'),
(2, 'User', 'user', NULL, 0, '2022-11-12 02:09:05', '2022-11-12 02:09:05'),
(3, 'Librarian', 'librarian', NULL, 0, '2022-11-12 10:47:14', '2022-11-15 02:55:23'),
(4, 'Teacher', 'teacher', NULL, 0, '2022-11-17 08:17:51', '2022-11-17 08:17:51'),
(6, 'Accountant', 'accountant', NULL, 0, '2022-11-19 00:14:27', '2022-11-19 00:14:27'),
(7, 'Student', 'student', NULL, 0, '2022-11-26 02:02:51', '2022-11-26 02:02:51');
...
INSERT INTO `supplier_invoices` (`id`, `school_id`, `product_id`, `total_price`, `payment`, `due`, `type`, `status`, `created_at`, `updated_at`) VALUES
(1, NULL, 1, 8750.00, 8750.00, 0.00, 'cash', 0, '2022-11-30 03:21:34', '2022-11-30 04:24:24'),
(2, NULL, 2, 75000.00, 70000.00, 5000.00, 'cash', 0, '2022-11-30 04:40:28', '2022-11-30 10:42:19');
...
CREATE TABLE `transports` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `schhol_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `route_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicle_num` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `route_fare` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `2021-2022_2_attandence`
--
ALTER TABLE `2021-2022_2_attandence`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `2021-2022_2_fees`
--
ALTER TABLE `2021-2022_2_fees`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `2021-2022_7_fees`
--
ALTER TABLE `2021-2022_7_fees`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `2021-2022_7_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2021_2022_7_students_student_id_foreign` (`student_id`);

--
-- Indexes for table `2021-2022_8_fees`
--
ALTER TABLE `2021-2022_8_fees`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `2021-2022_8_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2021_2022_8_students_student_id_foreign` (`student_id`);
...
ALTER TABLE `create_marks_1_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `create_marks_1_students_student_id_foreign` (`student_id`);
...
ALTER TABLE `create_marks_2_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `create_marks_2_students_student_id_foreign` (`student_id`);
...
--
-- Indexes for table `inventory_identities`
--
ALTER TABLE `inventory_identities`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `invent_suppliers`
--
ALTER TABLE `invent_suppliers`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `librarians`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `librarians_name_unique` (`name`),
  ADD UNIQUE KEY `librarians_email_unique` (`email`),
  ADD UNIQUE KEY `librarians_phone_unique` (`phone`);
...
--
-- Indexes for table `lost_inventories`
--
ALTER TABLE `lost_inventories`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `2021-2022_2_attandence`
--
ALTER TABLE `2021-2022_2_attandence`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `2021-2022_2_fees`
--
ALTER TABLE `2021-2022_2_fees`
...
--
-- AUTO_INCREMENT for table `2021-2022_7_fees`
--
ALTER TABLE `2021-2022_7_fees`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `2021-2022_8_fees`
--
ALTER TABLE `2021-2022_8_fees`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `inventory_identities`
--
ALTER TABLE `inventory_identities`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `invent_suppliers`
--
ALTER TABLE `invent_suppliers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `lost_inventories`
--
ALTER TABLE `lost_inventories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- Constraints for table `2021-2022_7_students`
--
ALTER TABLE `2021-2022_7_students`
  ADD CONSTRAINT `2021_2022_7_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `2021-2022_8_students`
--
ALTER TABLE `2021-2022_8_students`
  ADD CONSTRAINT `2021_2022_8_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `create_marks_1_students`
--
ALTER TABLE `create_marks_1_students`
  ADD CONSTRAINT `create_marks_1_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `create_marks_2_students`
--
ALTER TABLE `create_marks_2_students`
  ADD CONSTRAINT `create_marks_2_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;
