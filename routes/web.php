...
use App\Http\Controllers\editor\AddonsController;
...
Route::get('api/order/{order_id}/pay','frontEnd\PayNowController@payment_pay');
Route::post('api/order/payemnt/stripe','frontEnd\PayNowController@payment_pay_stripe');
Route::post('api/order/payemnt/paypal','frontEnd\PayNowController@payment_pay_paypal')->name('payment_pay_paypal_api');

// Route::get('order-complete/{orderId}','frontEnd\customerController@complete')->name('order_complete_api');
...
Route::group(['namespace'=>'frontEnd','middleware'=>['validcustomer']], function(){
    ...
    Route::get('customer/order-complete/{orderId}','customerController@complete')->name('order_complete');
...
Route::group(['as'=>'editor.', 'prefix'=>'editor', 'namespace'=>'editor','middleware'=>['auth', 'editor']], function(){
 Route::get('/dashboard', 'DashboardController@index')->name('dashboard');
    ...
    Route::get('gmail-setting/index', [SettingController::class, 'index']);
    ...
    // Product addons are here for
    Route::get('product-addon/manage', [AddonsController::class,'manage']);
    Route::get('product-addon/add', [AddonsController::class,'add']);
    Route::post('product-addon/store',[AddonsController::class,'store']);
    Route::post('product-addon/inactive',[AddonsController::class,'inactive']);
    Route::post('product-addon/active',[AddonsController::class,'active']);
    Route::get('product-addon/edit/{id}',[AddonsController::class,'edit']);
    Route::post('product-addon/update',[AddonsController::class,'update']);
