                                ...
                                <div class="productdetails-info">
                                    ...
                                    $totalReviewAmount = App\Review::where('product_id',$productdetails->id)->sum('ratting');
                                      ...
                                      <div class="details-pro-price">
                                         <span>{{ $setting->currency }} {{$productdetails->proNewprice}}</span>
                                         @if($productdetails->proOldprice)
                                         <del>{{ $setting->currency }} {{$productdetails->proOldprice}}</del>
                                         @endif
                                      </div>
                                      
                                      <div class="paid-addition">
                                          @if($productdetails->aditionalshipping)
                                          <p class="text-success"><i class="fa fa-truck"></i> Extra Shipping Charge {{ $setting->currency }} {{$productdetails->aditionalshipping}}</p>
                                          @endif
                                      </div>
