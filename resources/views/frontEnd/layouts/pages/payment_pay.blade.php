...
<head>
    ...
    <title>@yield('title','Welcome to Trusted Retail Store')  | Hungry</title>
    <!--website title-->
        ...
        <div class="col-lg-5 col-md-5 col-sm-5">
          <div class="alert alert-success mt-2 mb-2 text-center">
            <div class="text-center alert-warning">
                ...
                <span class="h5">Total Payment  - {{$contact->currency}} {{($order->orderTotal + Session::get('shippingfee')) - Session::get('couponamount')}}</span>
                ...
                <div class="form-group mt-2">
                    ...
                    <div class="mt-1">
                        ...
                        <div id="payment_stripe" class="d-none box box-primary text-left bg-light border mt-2">
                            ...
                            <form role="form" action="{{url('api/order/payemnt/stripe')}}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{$StripeSet->PublishableKey}}" id="payment-form">
                                @csrf
                                <input type="hidden" name="orderID" value="{{ $order->orderIdPrimary }}">
                                <input type="hidden" name="paymentType" value="stripe">
                                <input type="hidden" name="system" value="api">
  ...
  paypal.Buttons({
    ...
    onApprove: function(data, actions) {
      ...
      return actions.order.capture().then(function(details) {
          ...
          $.ajax({
            url: "{{route('payment_pay_paypal_api')}}",
            method: "POST",
            dataType: "JSON",
            ...
            success: function (res) {
              ...
              window.setTimeout(function () {
                window.location = "URL::to('/success')"; 
              }, 2000);
            },
            error: function(){
               window.setTimeout(function () {
                window.location = "URL::to('/fail')"; 
              }, 1000);
            }
          });
