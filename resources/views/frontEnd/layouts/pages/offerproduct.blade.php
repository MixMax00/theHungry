            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <li><a class="anchor">Special Offers </a></li>
                        </ul>
                    </div>
                </div>
            </div>
                          ...
                          <form action="" id="pricefilter">
                            @csrf
                              ...
                              <input type="text" name="maxprice" placeholder="Max" class="width40 maxprice">
                               <button type="submit" class="width20">Filter</button>
                          </form>
                        </div>
                    </div>
                    <div class="sidebar">
                      <div class="custom-tree">
                        <div class=" title ">
                          ...
                          <ul class="mtree transit">
                                ...
                                @endphp
                                <li><a href="{{url('category/'.$value->slug)}}">{{$value->name}}</span></a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                                          ...
                                          <div class="custom-tree">
                                              <ul class="mtree transit">
                                                    ...
                                                    @php
                                                        $productCount = App\Product::where('proCategory',$value->id)->count();
                                                    @endphp
                                                    <li><a href="{{url('category/'.$value->slug)}}">{{$value->name}} <span>({{$productCount}})</span></a>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                            </div>
