...
<head>
    ...
    <title>@yield('title','Welcome to Trusted Retail Store')  | {{ $setting->shop_name }}</title>
    <!--website title-->
    ...
    <!--mobilemenu css-->
    <link rel="stylesheet" href="{{asset('frontEnd')}}/css/jquery.mtree.css">
    <!-- nice select -->
    <link rel="stylesheet" href="{{asset('frontEnd')}}/css/nice-select.css">
      <!-- toastr css -->
    <link rel="stylesheet" href="{{asset('frontEnd')}}/css/toastr.min.css">
    <!--mtree css-->
    <link rel="stylesheet" href="{{asset('frontEnd')}}/css/mtree.css">
    <!--news.css-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        <p style="color:#fff">
                            Copyright ©  @php  echo date('Y') @endphp {{ $setting->shop_name }}. All rights reserved.
                            </p>
                    </div>
                </div>
            </div>
