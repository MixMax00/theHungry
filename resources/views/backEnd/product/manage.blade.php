        ...
        <div class="col-12">
          ...
          <!-- /.card-header -->
            <div class="card-body user-border">
               <table id="example" class="table  table-responsive-lg table-bordered table-striped">
                <thead>
                <tr>
                  <th>Sl</th>
                  <th>Name</th>
                ...
                <tfoot>
                  <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><strong>{{$totalprice}} {{ $setting->currency }}</strong></td>
                    <td></td>
                    <td><strong>{{$totalqty}} qty</strong></td>
                    <td></td>
                    <td></td>
                  </tr>
                </tbody>
