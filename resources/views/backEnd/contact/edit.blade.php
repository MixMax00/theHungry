                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="shop_name" class="form-control{{ $errors->has('shop_name') ? ' is-invalid' : '' }}" value="{{$edit_data->shop_name }}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="currency" class="form-control{{ $errors->has('currency') ? ' is-invalid' : '' }}" value="{{$edit_data->currency }}">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group custom-textarea">
                            <label for="maplink">Map Link</label>
                                  <textarea name="maplink" class="textarea form-control{{ $errors->has('maplink') ? ' is-invalid' : '' }}" cols="8" rows="8">{{$edit_data->maplink}}</textarea>

                              @if ($errors->has('maplink'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('maplink') }}</strong>
                                 </span>
                                 @endif
                            </div>
                       </div>
