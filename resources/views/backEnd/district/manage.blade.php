        ...
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Manage Country information</h3>
              ...
              <a href="{{url('admin/district/add')}}"><i class="fa fa-plus"></i>Add</a>
      			</div>
          </div>
          <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <td>
                    <ul class="action_buttons dropdown">
                        ...
                        @endif
                          ...
                          <li>
                        <a class="edit_icon" href="{{url('admin/district/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                      </li>
                      <li>
                        <form action="{{url('admin/district/delete')}}" method="POST">
                            @csrf
                            <input type="hidden" name="hidden_id" value="{{$value->id}}">
