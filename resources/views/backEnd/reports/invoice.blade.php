        ...
        <table>
            <tr>
                <td style="padding:30px 0">
                    ...
                    Country : @php $districtname = App\District::find($shippingInfo->district); @endphp {{$districtname->name}}<br>
                    @endif
                </td>
            ...
            <tbody>
             ...
             @foreach($orderDetails as $key=>$value)
                <tr style="border: 2px solid #ddd !important">
                    ...
                    <td>{{$value->productPrice}} x {{$value->productQuantity}} = {{ $setting->currency }} {{$value->productPrice*$value->productQuantity}} /-</td>
                </tr>
                @php
                ...
                <tr style="border: 2px solid #ddd !important">
                    ...
                    <td style="text-align:center;background:#eee !important;border: 2px solid #ddd !important"><strong>{{ $setting->currency }} {{$subtotal}} /-</strong></td>
                </tr>
                <tr style="border: 2px solid #ddd !important">
                    <td style="text-align:right;background:#eee !important;border: 2px solid #ddd !important"><strong>Shipping Fee</strong></td>
                    <td style="text-align:center;background:#eee !important;border: 2px solid #ddd !important"><strong>{{ $setting->currency }} {{$shippingInfo->shippingfee}} /-</strong></td>
                </tr>
                <tr style="border: 2px solid #ddd !important">
                    <td style="text-align:right;background:#eee !important;border: 2px solid #ddd !important"><strong>Discount</strong></td>
                    <td style="text-align:center;background:#eee !important;border: 2px solid #ddd !important"><strong>{{ $setting->currency }} {{$orderInfo->discount}} /-</strong></td>
                </tr>
                <tr style="border: 2px solid #ddd !important">
                    <td style="text-align:right;background:#eee !important;border: 2px solid #ddd !important"><strong>Total</strong></td>
                    <td style="text-align:center;background:#eee !important;border: 2px solid #ddd !important"><strong>{{ $setting->currency }} {{$orderInfo->orderTotal}} /-</strong></td>
                </tr>
            </tbody>
        </table>
        <table>
