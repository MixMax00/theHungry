...
@section('title','Region / State Manage')
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Manage Region / State information</h3>
      			<div class="short_button">
              <a href="{{url('admin/area/add')}}"><i class="fa fa-plus"></i>Add</a>
      			</div>
          </div>
          <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <td>
                    <ul class="action_buttons dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li>
                        @if($value->status==1)
                        <form action="{{url('admin/area/inactive')}}" method="POST">
                          @csrf
                        ...
                        @endif
                          ...
                          <li>
                        <a class="edit_icon" href="{{url('admin/area/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                      </li>
                      <li>
                        <form action="{{url('admin/area/delete')}}" method="POST">
                            @csrf
                            <input type="hidden" name="hidden_id" value="{{$value->id}}">
